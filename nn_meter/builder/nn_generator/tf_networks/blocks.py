...
def conv_bn(input_shape, config):
    ...
    return ConvBn(conv_op, bn_op)


def conv_relu(input_shape, config):
    conv_op, out_shape = conv(input_shape, config)
    relu_op, _ = relu(out_shape, config)
    
    class ConvRelu(keras.Model):
    ...
    return ConvRelu(conv_op, relu_op)


def conv_relu6(input_shape, config):
    conv_op, out_shape = conv(input_shape, config)
    relu6_op, _ = relu6(out_shape, config)
    
    class ConvRelu6(keras.Model):
    ...
    return ConvRelu6(conv_op, relu6_op)


def conv_hswish(input_shape, config):
    conv_op, out_shape = conv(input_shape, config)
    hswish_op, _ = hswish(out_shape, config)
    
    class ConvHswish(keras.Model):
    ...
    return ConvHswish(conv_op, hswish_op)
...
def dwconv_bn(input_shape, config):
    ...
    return DwConvBn(dwconv_op, bn_op)


def dwconv_relu(input_shape, config):
    dwconv_op, out_shape = dwconv(input_shape, config)
    relu_op, _ = relu(out_shape, config)
    
    class DwConvRelu(keras.Model):
    ...
    return DwConvRelu(dwconv_op, relu_op)


def dwconv_relu6(input_shape, config):
    dwconv_op, out_shape = dwconv(input_shape, config)
    relu6_op, _ = relu6(out_shape, config)
    
    class DwConvRelu6(keras.Model):
    ...
    return DwConvRelu6(dwconv_op, relu6_op)
