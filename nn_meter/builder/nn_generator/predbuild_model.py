...
def get_adasample_model(block_type, cfg):
      ...
      if block_type == 'fc':
            ...
            inputs = get_inputs_by_shapes([[1, cin]])
            input_tensor = inputs[0]
      ...
      if block_type == 'maxpool':
            ...
            inputs = get_inputs_by_shapes([[1, hw, hw, cin]])
            input_tensor = inputs[0]
      ...
      if block_type == 'concat':
            ...
            print('here')
            for c in cins:
                  inputs = get_inputs_by_shapes([[1, hw, hw, c]])
                  input_tensor = inputs[0]
      ...
      if block_type == 'concat-pad':
            ...
            hw = cfg['HW']
            inputts = []
            inputs = get_inputs_by_shapes([[1, hw, hw, 3]])
            input_tensor = inputs[0]
