...
configs = [
    ...
    },
    {
        ...
        'channel': channel_list(start=72, end=80, step=8),  
        'depth': [2, 3, 4, 5, 6],  
        'expansion_ratio': [4, 2],  
        'v_scale': [4, 2],   
        'stride': 2,          
    ...
    }, 
    {
        'name': 'stage_3', 
        'block_type': 1,  
        'cin': channel_list(start=72, end=80, step=8),
        'channel': channel_list(start=104, end=120, step=8),  
        'depth': [2, 3, 4, 5, 6],  
        'expansion_ratio': [4, 2],  
        'v_scale': [4, 2],
        'stride': 1,          
    ...
    },
    {
        'name': 'stage_4', 
        'block_type': 1,  
        'cin': channel_list(start=104, end=120, step=8),
        'channel': channel_list(start=176, end=200, step=8),  
        'depth': [3, 4, 5, 6, 7, 8],  
        'expansion_ratio': [4, 2],  
        'v_scale': [4, 2],
        'stride': 2,          
    ...
    },
    {
        'name': 'stage_5', 
        'block_type': 1,  
        'cin': channel_list(start=176, end=200, step=8),
        'channel': channel_list(start=296, end=320, step=8),  
        'depth': [3, 4, 5, 6, 7, 8],  
        'expansion_ratio': [4, 2],  
        'v_scale': [4, 2],
        'stride': 2,          
