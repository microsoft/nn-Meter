...
def light_multi_head_self_attention(inputs, num_heads=4, key_dim=0, sr_ratio=1, out_shape=None, out_weight=True, out_bias=False, attn_dropout=0, name=""):
    ...
    pos_query = tf.transpose(query, [0, 2, 1, 3])  # [batch, num_heads, hh, ww, key_dim]
...
def CMTTiny(input_shape=(160, 160, 3), num_classes=1000, activation="hard_swish", classifier_activation="softmax", pretrained=None, **kwargs):
