...
configs = [
    ...
    },
    {
        ...
        'channel': channel_list(start=64, end=96, step=16) + extend_width[0],  
        'depth': [1, 2, 3, 4, 5],  
    ...
    },
    {
        'name': 'stage_4', 
        'block_type': 1,  
        'cin': channel_list(start=64, end=96, step=16) + extend_width[0],
        'channel': channel_list(start=80, end=160, step=16) + extend_width[1],
        'depth': [1, 2, 3, 4, 5, 6],  
        'expansion_ratio': [2, 3, 4, 5],  
        'downsample_expansion_ratio': [4, 6],
        'v_scale': [2, 3, 4],
    ...
    },
    {
        'name': 'stage_5',
        'block_type': 1,
        'cin': channel_list(start=80, end=160, step=16) + extend_width[1],
        'channel': channel_list(start=144, end=288, step=16) + extend_width[2],
        'depth': [1, 2, 3, 4, 5, 6],
        'expansion_ratio': [2, 3, 4, 5],
        'downsample_expansion_ratio': [4, 6],
        'v_scale': [2, 3, 4],
    ...
    },
    {
        'name': 'stage_6',
        'block_type': 1,
        'cin': channel_list(start=144, end=288, step=16) + extend_width[2],
        'channel': channel_list(start=160, end=320, step=16) + extend_width[3],
        'depth': [1, 2, 3, 4, 5, 6],
        'expansion_ratio': [2, 3, 4, 5],
        'downsample_expansion_ratio': [4, 6],
        'v_scale': [2, 3, 4],
    ...
    },
    {
        'name': 'mb_pool',
        'block_type': 2,
        'cin': channel_list(start=160, end=320, step=16) + extend_width[3],
