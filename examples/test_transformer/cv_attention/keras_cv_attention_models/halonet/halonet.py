...
def halo_attention(
    ...
    B, _heads, patch, cc_aa = attention_output.shape
    heads = int(_heads / ww_kk / hh_kk)
    ww_aa = ww_kk
    hh_aa = hh_kk
...
# def HaloNetH0(input_shape=(224, 224, 3), num_classes=1000, activation="swish", classifier_activation="softmax", pretrained="imagenet", **kwargs):
...
def HaloNetH1(input_shape=(224, 224, 3), num_classes=1000, activation="swish", classifier_activation="softmax", pretrained="imagenet", **kwargs):
