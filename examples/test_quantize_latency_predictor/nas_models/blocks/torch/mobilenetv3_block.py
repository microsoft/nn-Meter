...
class SE(nn.Module):
    def __init__(self, num_channels, se_ratio=0.25):
        ...
        self.conv1 = nn.Conv2d(num_channels, mid_channels, kernel_size=1, stride=1, padding=0)
        self.conv2 = nn.Conv2d(mid_channels, num_channels, kernel_size=1, stride=1, padding=0)
        self.relu = nn.ReLU()
