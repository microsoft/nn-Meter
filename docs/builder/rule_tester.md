...
The test case models will be saved in `<workspace-path>/rule_test/models/`, and the test case dictionary will be saved in `<workspace-path>/rule_test/results/origin_testcases.json`.
